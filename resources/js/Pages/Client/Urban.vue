...
<template>
    ...
    <div class="table-container overflow-x-auto">
            ...
            <tbody>
                <tr>
                  <td class="py-4 px-2">83773578</td>
                  <td class="py-4 px-2">Kathonzweni</td>
                  <td class="py-4 px-2">Kennedy Muendo</td>
                  <td class="py-4 px-2">Kshs. 100,000</td>
    ...
    <Link method="post" as="button" :href="route('client.conditions')" class="my-7 w-[300px] block rounded-3xl border-none outline-none bg-[#2DE19D] py-3 px-6 text-center text-base capitalize text-black cursor-pointer transition-all duration-300 ease-in-out hover:bg-[#15f49f]">Click here to begin the process</Link>
    <hr>
  </section>
  <Footer/>
</template>
