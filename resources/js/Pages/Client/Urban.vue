...
<template>
    <Header/>
    <section class="urban">
    <div class="urban-title"><span>Urban</span> Land plots</div>
    ...
    <div class="table-container overflow-x-auto">
            ...
            <tbody>
                <tr>
                  <td class="py-6 px-2">83773578</td>
                  <td class="py-6 px-2">Kathonzweni</td>
                  <td class="py-6 px-2">Kennedy Muendo</td>
                  <td class="py-6 px-2">Kshs. 100,000</td>
